...
Bei dem Ressourcenplan kann zwischen Hardware- und Softwareressourcen, wie auch zwischen monetärem und nicht-monetärem Aufwand unterschieden werden.
...
\begin{table}[ht]
	\begin{center}
		\begin{tabular}{ ||l|r|| }
			...
			8. Query-Generator implementieren                               & 5 h 			\\
			9. Datenkonvertierung einbinden    						        & 4 h 			\\
			10. Refaktorierung der bestehenden Datenbanklogik               & 2 h 			\\
			11. Test der neuen Datenbankkommunikation						& 2 h 			\\			
			\hline
